...
<body class="hold-transition skin-purple sidebar-mini">
					...
					<div class="box-footer">
						...
						<div class="box-tools pull-right">
							<ul class="pagination">
								...
								<li><a href="${pageContext.request.contextPath}/product/findAll.do?currentPage=${pageInfo.prePage}&pageSize=${pageInfo.pageSize}">上一页</a></li>
								<c:forEach begin="1" end="${pageInfo.pages}" var="num">
									<li><a href="${pageContext.request.contextPath}/product/findAll.do?currentPage=${num}&pageSize=${pageInfo.pageSize}">${num}</a></li>
								</c:forEach>
	...
	<script>
		function refresh() {
			location.href = "${pageContext.request.contextPath}/product/findAll.do?currentPage=1&pageSize=5"
		}
		//控制分页
